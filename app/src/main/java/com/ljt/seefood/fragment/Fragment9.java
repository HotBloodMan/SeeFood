...
public class Fragment9 extends Fragment {
    private static Fragment9 instance;
    private View view;
    public Fragment9(){}
    @Nullable
    @Override
    ...
    public static Fragment9 genInstance(){
        if (instance==null) {
            instance = new Fragment9();
            return instance;
        }
        return instance;
    }
    ...
    private void initView() {
        ...
        NewsData newsDate = new NewsData(getActivity(),"caijing",progressBar,relativeLayout,updateBut,pullToRefreshListView);
        newsDate.getData();
    }
}
