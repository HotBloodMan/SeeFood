...
public class Fragment7 extends Fragment {
    private static Fragment7 instance;
    ...
    public static Fragment7 genInstance(){
        if (instance==null) {
            instance = new Fragment7();
            return instance;
        }
        return instance;
    }
    ...
    private void initView() {
        ...
        NewsData newsDate = new NewsData(getActivity(),"junshi",progressBar,relativeLayout,updateBut,pullToRefreshListView);
        newsDate.getData();
    }
}
