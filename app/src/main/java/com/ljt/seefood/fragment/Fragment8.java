...
public class Fragment8 extends Fragment {
    private static Fragment8 instance;
    ...
    public static Fragment8 genInstance(){
        if (instance==null) {
            instance = new Fragment8();
            return instance;
        }
        return instance;
    }
    ...
    private void initView() {
        ...
        NewsData newsDate = new NewsData(getActivity(),"guonei",progressBar,relativeLayout,updateBut,pullToRefreshListView);
        newsDate.getData();
    }
}
