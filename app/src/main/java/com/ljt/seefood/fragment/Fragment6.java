...
public class Fragment6 extends Fragment {
    private static Fragment6 instance;
    ...
    public static Fragment6 genInstance(){
        if (instance==null) {
            instance = new Fragment6();
            return instance;
        }
        return instance;
    }
    ...
    private void initView() {
        ...
        NewsData newsDate = new NewsData(getActivity(),"tiyu",progressBar,relativeLayout,updateBut,pullToRefreshListView);
        newsDate.getData();
    }
}
