...
import com.ljt.seefood.utils.NetConnectedUtils;
import com.ljt.seefood.utils.ToastUtil;
...
public class VideoDetailActivity extends AppCompatActivity {
    ...
    @OnClick({R.id.video_paly, R.id.video_detail_iv_fav, R.id.video_detail_iv_share,
            R.id.video_detail_iv_reply, R.id.video_detail_iv_down})
